...
public abstract class AbstractCameraXActivity<R> extends BaseModuleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (devicePolicyManager.getCameraDisabled(null)) {
            Toast.makeText(this, "Camera is disabled by device policy", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
        ...
        cameraProviderFuture.addListener(() -> {
            try {
                ...
                imageAnalysis.setAnalyzer(executor, image -> {
                    ...
                    if (currentTime - mLastAnalysisResultTime < 500) {
                        image.close();
                        return;
                    }
                    ...
                    if (result != null) {
                        mLastAnalysisResultTime = currentTime;
